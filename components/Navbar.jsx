                ...
                <div className="flex items-center justify-between max-w-7xl mx-auto py-3 transition-all">
                    ...
                    <div className="hidden sm:flex items-center gap-4 lg:gap-6 text-slate-700 font-medium">
                        ...
                        <form onSubmit={handleSearch} className="hidden xl:flex items-center w-xs text-sm gap-2 bg-slate-50 border border-slate-200 px-4 py-2.5 rounded-lg hover:border-yellow-400 transition">
                            ...
                            <input className="w-full bg-transparent outline-none placeholder-slate-400" type="text" placeholder="Search for products" value={search} onChange={(e) => setSearch(e.target.value)} required />
                        </form>
                        ...
                        <Link href="/cart" className="relative flex items-center gap-2 text-slate-700 hover:text-yellow-600 transition font-semibold">
                            ...
                            Cart
                            <button className="absolute -top-2 left-4 text-[10px] font-bold text-white bg-red-500 px-1.5 py-0.5 rounded-full">{cartCount}</button>
                        </Link>

                        <button className="px-6 py-2 bg-green-600 hover:bg-green-700 transition text-white rounded-lg font-semibold">
                            Login
                        </button>
                    ...
                    <div className="sm:hidden">
                        <button className="px-6 py-1.5 bg-green-600 hover:bg-green-700 text-sm transition text-white rounded-lg font-semibold">
                            Login
                        </button>
                    </div>
                </div>
